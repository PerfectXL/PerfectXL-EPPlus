    ...
    public class ExcelVmlDrawingComment : ExcelVmlDrawingBase, IRangeID
    {
        ...
        public Color BackgroundColor
        {
            get
            {
                ...
                else
                {
                    ...
                    if (int.TryParse(col, System.Globalization.NumberStyles.AllowHexSpecifier, CultureInfo.InvariantCulture, out var res))
                    {
        ...
        public Single LineWidth
        {
            get
            {
                ...
                if (Single.TryParse(wt, System.Globalization.NumberStyles.Any, CultureInfo.InvariantCulture, out var ret))
                {
                    return ret;
                }
                else
