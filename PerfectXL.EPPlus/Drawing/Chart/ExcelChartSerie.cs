...
namespace OfficeOpenXml.Drawing.Chart
{
    ...
    public class ExcelChartSerie : XmlHelper
    {
        ...
        {
            get => _trendLines ?? (_trendLines = new ExcelChartTrendlineCollection(this));
        }
        ...
        {
            get => _fill ?? (_fill = new ExcelDrawingFill(NameSpaceManager, TopNode, "c:spPr"));
        }
        ...
        {
            get => _border ?? (_border = new ExcelDrawingBorder(NameSpaceManager, TopNode, "c:spPr/a:ln"));
        }
    }
}
