...
After:
                    ExcelCellBase.GetRowColFromAddress(xr.GetAttribute("ref"), out fromRow, out fromCol, out toRow, out var toCol);
*/
...
After:
                ExcelCellBase.GetRowColFromAddress(f.Address, out fromRow, out fromCol, out var toRow, out toCol);
*/
